...
class PerfilPacienteActivity : AppCompatActivity(), IPerfilPacienteView {
    ...
    private lateinit var btnRegistroCorpotal: MaterialButton
    ...
    private fun setupUI() {
        ...
        btnRegistroCorpotal = findViewById(R.id.btnRegistroCorpotal)

        btnUpdate.setOnClickListener {
            updatePacienteInfo()
        }

        btnRegistroCorpotal.setOnClickListener {
            cargarDatosCorporales()
        }
    }
    ...
    private fun cargarDatosCorporales(){
        val regCorporal : Intent = Intent(applicationContext,RegistroCorporalActivity::class.java)
        startActivity(regCorporal)
    }
